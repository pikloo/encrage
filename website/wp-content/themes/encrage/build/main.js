...
var serieSection = document.querySelector("#serie");
var gallerySerieSection = document.querySelector(".gallery");
var serieNavigation = document.querySelector(".serie-nav");
var galleryCallback = function galleryCallback(entries) {
...
var gallerySerieSectionObserver = new IntersectionObserver(galleryCallback, {
  rootMargin: '-280px',
  threshold: 0
});
...
if (serieSection) {
  serieSection.style.height = "".concat(screenHeight - header.offsetHeight - portfolioTitle.offsetHeight, "px");
}
...
main.style.paddingTop = "".concat(header.offsetHeight, "px");
...
var hasShownPopup = false; // Évite de montrer la popup plusieurs fois

// Fonction pour vérifier la position de défilement
function checkScrollPosition() {
  var scrollTop = window.scrollY; // Position actuelle de défilement
  var windowHeight = window.innerHeight; // Hauteur de la fenêtre
  var fullHeight = document.documentElement.scrollHeight; // Hauteur totale du document

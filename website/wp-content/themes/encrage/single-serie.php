    ...
    <?php while ($loop->have_posts()) : $loop->the_post(); ?>
        ...
        <div class="flex flex-col justify-between">
            <section id="serie" class="relative h-[calc(100dvh-5rem)] custom-landscape:h-[calc(100dvh-5rem)] md:h-[calc(100dvh-7rem)] flex flex-col justify-evenly">
                ...
                <div class="swiper gallery lg:mt-4 h-[70vh] relative w-full">
                    <div class="swiper-wrapper items-center h-full">
                        <?php foreach ($url_array as $image_url) : ?>
                            <div class="swiper-slide lg:w-fit">
                                <img class="gallery-img h-[70vh] object-contain mx-auto" src="<?= $image_url; ?>" alt="<?= esc_attr(get_the_title()) ?>" />
                            </div>
                        <?php endforeach; ?>
                    </div>
                ...
                <ul class="flex justify-center gap-x-4 serie-nav">
                    <li>
                        <a href="#" aria-current="location" data-serie-anchor-link class="menu-item inline-block w-fit">
                            <h2 class="w-fit font-bold">Série</h2>
                        </a>
                    </li>
                    <li>
                        <a href="#" aria-current="false" data-about-anchor-link class="menu-item inline-block w-fit">

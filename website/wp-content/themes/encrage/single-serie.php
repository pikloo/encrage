...
<main class="overflow-hidden main relative">
    <?php while ($loop->have_posts()) : $loop->the_post(); ?>
        ...
        <div class="portfolio-title pt-2 bg-white/60 px-2 md:px-0 w-full z-[11]">
                    <div class="justify-center items-center flex gap-x-4" >
        ...
        <section id="serie" class="relative h-[calc(100dvh-8rem)] custom-landscape:h-[calc(100dvh-8rem)] md:h-[calc(100dvh-10rem)] flex flex-col justify-between gap-y-3 md:gap-y-6 py-2">

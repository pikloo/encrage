            ...
            <div class="flex flex-col justify-center items-center gap-4">
                ...
                <div class="text-center">
                    <div class="-translate-y-6 before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-black relative inline-block">
                        <h3 class="relative text-xl font-medium uppercase text-white"><?= $photographer['firstname'] && $photographer['lastname'] ?  $photographer['firstname'] . ' ' . $photographer['lastname'] : $photographer['nickname'] ?></h3>
                    </div>
                    <ul class="md:hidden">

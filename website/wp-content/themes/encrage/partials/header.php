<header class="h-36 px-10 flex items-center w-full fixed top-0 left-0 right-0 z-10 bg-white<?php if(is_home()) echo '/70' ?>">
      <nav class="relative flex justify-between items-center w-full">
        <a href="#"><img src="<?= get_template_directory_uri(); ?>/assets/images/logo-encrage.png" alt="Encrage" /></a>
        <div class="xl:hidden">
      ...
      <div class="navbar-menu relative z-[60] hidden">
        ...
        <nav
          class="fixed bg-white top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto"
        >
          <div class="flex items-center mb-8">
            ...
            <button class="navbar-close">
              <svg
                class="h-6 w-6 text-third cursor-pointer hover:text-secondary"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"

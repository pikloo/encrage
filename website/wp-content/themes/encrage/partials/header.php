...
<header class="main-header flex items-center shadow-sm w-max-w-sm lg:w-full fixed top-0 left-0 right-0 z-20 bg-white duration-500 delay-2">
  <nav class="relative w-full lg:pr-10 flex lg:justify-between items-center bg-white">
    ...
    <a aria-label="Revenez à notre page d'accueil" class="z-20 bg-white w-full custom-landscape:w-full lg:w-fit custom-landscape:p-0 lg:py-6" href=<?= home_url(); ?>><img src="<?= wp_get_attachment_image_url($logo_site_attachment_id, 'medium'); ?>" alt="<?= esc_html(get_bloginfo('description')) ?> " class="w-[150px] custom-landscape:w-[150px] md:w-[200px] lg:w-[250px] logo-site mx-auto lg:px-10 lg:m-0" /></a>
            ...
            <div class="container mx-auto w-full">
              <ul class="grid grid-cols-4 gap-y-3">
                ...
                ?>
                  ...
                  <img class="h-12 w-12 rounded-full object-cover <?php if (!get_the_post_thumbnail()) echo "border border-black" ?>" src=<?= esc_url($thumbnailUrl); ?> alt="" />
       ...
       after:absolute after:w-[100px]">
          ...
          <div class="py-6 space-y-6 text-lg custom-landscape:text-lg md:text-xl lg:text-2xl text-center duration-500">
            <div>
              ...
              <a aria-label="Retrouvez nous sur PixPalace" href="https://www.pixpalace.com/" target="_blank"><img src="<?= get_template_directory_uri() ?>/assets/images/logo_pixpalace.png" alt="Retrouvez aussi nos photos sur PixPalace" class="w-[100px] md:lg:w-[150px] lg:w-[175px] mx-auto duration-500" /></a>
            </div>
            <div>
              ...
              <ul class="flex gap-x-2 mx-auto w-fit socials-links">
                ...
                <li><a aria-label="Retrouvez nous sur Facebook" href="https://www.facebook.com/encrage.photo" target="_blank">
